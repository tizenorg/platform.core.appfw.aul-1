 ...
 */
int aul_sock_send_raw_with_reply(int pid, uid_t uid, int cmd, unsigned char *kb_data, int datalen)
{
	int fd;
	int len;
	int sent = 0;
...
app_pkt_t *aul_sock_recv_raw(int fd, int *clifd, struct ucred *cr)
{
	int len;
	int ret;
