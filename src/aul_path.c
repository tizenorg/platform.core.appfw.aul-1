...
static int __get_path_form_db(char **path, const char *appid, const char *dir_name,
		uid_t uid)
{
	char *_path;
	char buf[PATH_MAX];
...
SLPAPI const char *aul_get_app_resource_path(void)
{
	...
	return __get(&path, NULL, _RESOURCE_DIR, getuid(), __get_path_form_db);
}
...
SLPAPI const char *aul_get_app_tep_resource_path(void)
{
	...
	return __get(&path, NULL, _TEP_RESOURCE_DIR, getuid(), __get_path_form_db);
}
...
SLPAPI const char *aul_get_app_shared_resource_path(void)
{
	...
	return __get(&path, NULL, _SHARED_RESOURCE_DIR, getuid(), __get_path_form_db);
}
		...
		char **path)
{
	...
	return __get_path_form_db(path, appid, _SHARED_RESOURCE_DIR, getuid());
}
		...
		char **path, uid_t uid)
{
	...
	return __get_path_form_db(path, appid, _SHARED_DATA_DIR, uid);
}
		...
		char **path, uid_t uid)
{
	...
	return __get_path_form_db(path, appid, _SHARED_RESOURCE_DIR, uid);
}
		...
		char **path, uid_t uid)
{
	...
	return __get_path_form_db(path, appid, _SHARED_TRUSTED_DIR, uid);
}
