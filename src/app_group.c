...
API int aul_app_group_clear_top(void)
{
	...
	return  aul_socket_send_raw_with_reply(AUL_UTIL_PID, getuid(), APP_GROUP_CLEAR_TOP, dummy, 0);
}
...
API void aul_app_group_lower(int *exit)
{
	...
	ret = aul_socket_send_raw_with_reply(AUL_UTIL_PID, getuid(), APP_GROUP_LOWER, dummy, 0);
	*exit = ret;
}
