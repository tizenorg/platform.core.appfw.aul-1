...
API int aul_app_get_pid(const char *appid)
{
	...
	ret = aul_socket_send_raw_with_reply(AUL_UTIL_PID, getuid(), APP_GET_PID,
...
API int aul_app_is_running(const char *appid)
{
	...
	ret = aul_socket_send_raw_with_reply(AUL_UTIL_PID, getuid(), APP_IS_RUNNING,
			(unsigned char*)appid, strlen(appid));
					...
					void *user_param)
{
	...
	pkt = aul_socket_send_raw_with_pkt_reply(AUL_UTIL_PID, getuid(),
...
API int aul_app_get_appid_bypid_for_uid(int pid, char *appid, int len, uid_t uid)
{
	...
	if (pid != getpid()) {
		pkt = aul_socket_send_raw_with_pkt_reply(AUL_UTIL_PID, uid,
...
API int aul_app_get_pkgid_bypid_for_uid(int pid, char *pkgid, int len, uid_t uid)
{
	...
	pkt = aul_socket_send_raw_with_pkt_reply(AUL_UTIL_PID, uid, cmd,
...
API int aul_delete_rua_history(bundle *b)
{
	...
	ret = aul_socket_send_raw_with_pkt_reply(AUL_UTIL_PID, getuid(),
