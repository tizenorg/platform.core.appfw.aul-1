...
SLPAPI aul_app_com_permission_h aul_app_com_permission_create()
{
...
SLPAPI void aul_app_com_permission_destroy(aul_app_com_permission_h permission)
{
	if (permission)
		g_free(permission);
}

SLPAPI int aul_app_com_permission_set_propagation(aul_app_com_permission_h permission, aul_app_com_propagate_option_e option)
{
	if (permission)
...
SLPAPI int aul_app_com_permission_set_privilege(aul_app_com_permission_h permission, const char *privilege)
{
	if (permission) {
...
SLPAPI int aul_app_com_create(const char *endpoint, aul_app_com_permission_h permission, app_com_cb callback, void *user_data, aul_app_com_connection_h *connection)
{
	bundle *b = NULL;
	int ret = 0;
...
SLPAPI int aul_app_com_join(const char *endpoint, const char *filter, app_com_cb callback, void *user_data, aul_app_com_connection_h *connection)
{
	bundle *b = NULL;
	int ret = 0;
...
SLPAPI int aul_app_com_leave(aul_app_com_connection_h connection)
{
	bundle *b = NULL;
	int ret = 0;
	GList *head = handlers;
