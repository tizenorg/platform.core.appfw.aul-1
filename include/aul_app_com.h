...
aul_app_com_create("widget.status", permission, __handler, NULL);
...
aul_app_com_join("widget.status", NULL, __handler, NULL);
...
int aul_app_com_create(const char *endpoint, aul_app_com_permission_h permission, app_com_receiver handler, void *user_data);
