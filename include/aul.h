...
/**
 * @par Description:
 *	This API sets callback function that will be called when the status info of an application is changed.
 * @par Purpose:
 *	The purpose of this API is to listen the status info of the applications.
 *
 * @param[in]	func		callback function
 * @param[in]	data		user data
 * @return	0 if success, negative value if fail.
