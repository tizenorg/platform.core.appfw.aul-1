...
int launch_test_with_uid()
{
	...
	ret = aul_launch_app_with_uid(gargv[2], kb, atoi(gargv[3]));
...
static test_func_t test_func[] = {
	...
	{"launch_with_uid", launch_test_with_uid, "launch with uid test",
		"[usage] launch_with_uid <appid> <uid>"},
